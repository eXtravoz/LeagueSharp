...
namespace FarmHelper.Plugin
{
    class Veigar
    {
        ...
        {
            {SpellSlot.Q, new Spell(SpellSlot.Q, 650f)},
        };
        ...
        {
            var fm = _config = new Menu("Veigear FHelper", "FMVeigar", true);
            fm.SubMenu("FMVeigar").AddItem(new MenuItem("fmEnable", "Enabled").SetValue(true));
            fm.SubMenu("FMVeigar").AddItem(new MenuItem("fmEnableQ", "Use Q").SetValue(true));
